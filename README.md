...
Current commands:
- **.pcinfo** - Fetch information about the computer using the ```computerinfo``` command in command prompt.
- **.hardware** - Fetch information about the computer's hardware [GPU/CPU Name, HWID, RAM Capacity, Disk Capacity]
